...
data_original <- data.frame(anes$dem_edugroup, anes$envir_gwhow)

# Rename catergorical variables to make them shorter
library(plyr)
data_original$edu <- revalue(data_original$anes.dem_edugroup, c("Less Than High School Credential" = "Less HS", 
                                              "High School Credential" = "HS",
                                              "Some Post-High-School, No Bachelor'S Degree" = "Post-HS",
                                              "Bachelor'S Degree" = "Bach",
                                              "Graduate Degree" = "Grad Deg"))
data_original$envir <- revalue(data_original$anes.envir_gwhow, c("Mostly By Human Activity" = "Human", 
                                               "Mostly By Natural Causes" = "Natural",
                                               "About Equally By Human Activity And Natural Causes" = "Equal"))

# Isolate only the renamed columns of data
data <- data_original[, c("edu", "envir")]
```
